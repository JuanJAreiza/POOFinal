...
public class EJEMPLOPROFE extends JFrame {
	...
	public EJEMPLOPROFE() {
		...
		btnCalcular.setIcon(new ImageIcon(EJEMPLOPROFE.class.getResource("/Imagenes/Calcular.png")));
		...
		btnCalcular.setBounds(174, 298, 108, 95);
